...
<script>
	...
	function load_data() {
		...
		var url="get_data.php?req=manage_pr&type=-1";
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
		...
		var url="get_data.php?req=manage_pr&type=0";
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
	...
	function accept(pr_id){
		var url="upd_del.php?op=pr_accept&pr_id="+pr_id;
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
	...
	function reject(pr_id){
		var url="upd_del.php?op=pr_reject&pr_id="+pr_id;
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
