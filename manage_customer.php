...
<script>
	...
	function load_data() {
		...
		var url="get_data.php?req=manage_cu&type=-1";
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
		...
		var url="get_data.php?req=manage_cu&type=0";
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
	...
	function accept(cu_id){
		var url="upd_del.php?op=cu_accept&cu_id="+cu_id;
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
	...
	function reject(cu_id){
		var url="upd_del.php?op=cu_reject&cu_id="+cu_id;
		// alert(url);
		$.ajax({
			type: "GET",
			url: url,
