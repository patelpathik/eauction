...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2019 at 07:43 AM
...
CREATE TABLE `category` (
  ...
  `status` varchar(5) NOT NULL DEFAULT '-1',
  `added_by` varchar(5) NOT NULL DEFAULT '-1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `category` (`cat_id`, `category`, `status`, `added_by`) VALUES
(5, 'Book', '1', '3'),
(7, 'Clothes', '1', '3'),
(8, 'Painting', '1', '3'),
(9, 'Ordinance', '1', '3'),
...
(7, 'krushali', 'patel', 'krushali.patel@gmail.com', '123', NULL, NULL, NULL, NULL, '1'),
